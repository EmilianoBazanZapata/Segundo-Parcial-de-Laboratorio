<%-- 
    ...
    Created on : 22 oct. 2020, 20:23:09
    Author     : Emiliano
--%>
            ...
            <c:when test="${usr}">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card card-signin my-5 ">
                                <div class="card-body">
                                    <h5 class="card-title text-center">Agregar Socio</h5>
                                    <form method="POST" action="ABMSocio?modo=agregarsocio" name="AgregarSocio" onsubmit = "return ValidarSocio()">
                                        <table>                
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary btn-block" onclick = "return ValidarSocio()">Agregar</button>     
                                            </div>
                                        </table>
                                    </form>
                                    <div>
                                        <a href="ListadoDeSocios?modo=versocios"type=" submit" class="btn btn-danger btn-block">Volver</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <script type="text/javascript">
                    ...
                    function ValidarApellido()
                    {
                        ...
                        if (apellido === "")
                        {
                            error.textContent = " Debe Ingresar Un Apellido ";
                            return false;
                        } else if (apellido.length < 3)
                        {
                            error.textContent = " El Apellido Es Muy Pequeño";
                            return false;
