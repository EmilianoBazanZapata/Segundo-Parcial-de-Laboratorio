                    ...
                    <table class="table table-bordered" >
                        ...
                        <c:forEach items="${SocioBuscadoPorDni}" var="s">
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="ABMSocio?modo=editar&id=${s.id_socio}" class="btn btn-outline-success btn-sm "name="btnEditar">Editar</a>
                                    <a href="ABMSocio?modo=eliminar&id=${s.id_socio}" class="btn btn-outline-danger btn-sm ">Dar de baja</a>
                                    <a href="ABMSocio?modo=agregaractividad&id=${s.id_socio}" class="btn btn-outline-info btn-sm ">Agregar Actividad al Socio</a>
                                </td>
                            </tr> 
                        </c:forEach>       
                    </table>
