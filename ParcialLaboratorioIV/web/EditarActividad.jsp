                ...
                <div class="col-sm-12">
                    <div class="card card-signin my-5">
                        <div class="card-body">
                            ...
                            <form method="POST" action="EditarActividad?id=${IdActividad}" name="AgregarActividad" onsubmit="return validar()">
                                <table>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="txtActividad"
                                                   placeholder="Ingrese una Actividad" value="${Actividad}" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" class="form-control" name="txtPrecio"
                                                   placeholder="Ingrese un Precio" value="${Precio}" min="0" pattern="^[0-9]+"required>
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div>
                                <a href="ListadoDeActividades"type=" submit" class="btn btn-danger btn-block">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
