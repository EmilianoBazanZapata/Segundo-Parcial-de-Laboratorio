 ...
 * @author Emiliano
 */
@WebServlet(name = "BuscarNoticiaInvitados", urlPatterns = {"/BuscarNoticiaInvitados"})
public class BuscarNoticiaInvitados extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Noticia> lista = g.ObtenerNoticiaPorId(id);
